...
{
  if(($_REQUEST["rname"]=="") ||($_REQUEST["rcollage"]=="") || ($_REQUEST["remail"]==""))
  {
          ...
          else
          {
            ...
            $result=$conn->query($sql);
              ...
              else
              {
                  ...
                  $sql="insert into user(name,gender,collage,email,password) VALUES
                   ('$rname','$rgender','$rcollage','$remail','$rpassword')";
        ...
        <div class="col-md-6 col-sm-6 offset-md-3 text-white" style="background-color: rgba(0, 0, 0, 0.6);">
          <form action="" method="POST" class="p-3" id="myForm">
            ...
            <div class="navbar-nav">
                <a href="user/login.php" class="btn btn-primary "  style="color: blue;">Login</a>
              </div>
